...
import { putAvatar } from "@/services/auth.service";
...
import { Avatar, Button, Modal, Spin, Upload } from "antd";
    ...
    const handleChangeAvatar = async () => {
        ...
        if (res.data) {
            ...
            if (resRelogin.error && resRelogin.status !== 200) {
                toast.error(
                    "Đã có lỗi xảy ra trong quá trình cập nhật, vui lòng đăng nhập lại"
                );
                signOut();
                router.push("/auth");
            }
